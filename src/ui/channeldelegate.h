...
// Draws one row of the channel sidebar: a type icon spanning two lines of text,
// with the channel name and when it last carried traffic on the first line, and
// the newest message plus an unread pill on the second.
